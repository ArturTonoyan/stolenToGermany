...
export default {
  ...
  async update(
    ...
    if(localityWork && !validateDeparture(localityWork)) throw new AppErrorInvalid('localityWork')
    if(localityDeparture && !validateDeparture(localityDeparture)) throw new AppErrorInvalid('localityDeparture')
    if(addressAfterReturning && !validateLetterNumeric(addressAfterReturning)) throw new AppErrorInvalid('addressAfterReturning')

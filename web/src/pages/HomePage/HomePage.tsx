    ...
    <div className={styles.HomePage}>
      ...
      <div className={styles.about}>
        <div className={styles.about_inner} id="about">
          ...
          <ul>
            <li>
              свыше 109 млн. оцифрованных страниц архивных документов, общим
              объемом 135 терабайт;
            </li>
            <li>
              67 млн. записей из 25 млн. цифровых копий документов о
              безвозвратных потерях Красной армии, военно-пересыльных пунктов и
              запасных полков;
            </li>
            <li>более 79 000 паспортов воинских захоронений;</li>
            <li>более 41 млн. записей документов по награждениям;</li>
            <li>
              около 51 800 исторических карт и схем боевых действий штабов
              фронтов, армий и дивизий, 12,5 млн. записей с информацией на
              картах о совершенных подвигах солдат и офицеров;
            </li>
            <li>
              27 млн. записей из карточек о ранениях и умерших от ран в
              госпиталях и медсанбатах;
            </li>
            <li>
              описание 227 крупнейших сражений Великой Отечественной войны.
            </li>
          </ul>
        </div>
      </div>

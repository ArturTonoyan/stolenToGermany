      ...
      <div className={styles.blockInput}>
        <div className={styles.blockFormFirst}>
          ...
          <input
            ...
            maxLength={50}
            {...register("patronumic", { maxLength: 20 })}
          />
          <input
            placeholder="Имя"
            maxLength={50}
          ...
          <input
            ...
            maxLength={50}
            {...register("burthDate", { maxLength: 50 })}
          />
        </div>
